...
class SheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sheet" do
    assert_difference('Sheet.count') do
      post sheets_url, params: { sheet: { description: @sheet.description, rate: @sheet.rate } }
    end
  ...
  test "should update sheet" do
    patch sheet_url(@sheet), params: { sheet: { description: @sheet.description, rate: @sheet.rate } }
